...
use App\Http\Middleware\UserWorkMiddleware;
use App\Http\Middleware\EnrollmentMiddlewaree;
...
class Kernel extends HttpKernel
{
    ...
    protected $routeMiddleware = [
        ...
        'EnrollmentMiddleware'=>EnrollmentMiddlewaree::class,
        'UserWorkMiddleware'=>UserWorkMiddleware::class,
        'MessageMiddleware'=>MessageMiddleware::class,
