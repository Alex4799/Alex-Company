            ...
            <div class="col-lg-10 offset-1">
                <div class="card bg-black">
                    <div class="card-body">
                        ...
                        <hr>
                            <form action="{{route('customer#updateProfile',Auth::user()->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                ...
                                <div class="col-6 offset-1">
                                    ...
                                    <input value="{{Auth::user()->position}}" type="hidden" name="position" class=" form-control">
                                    ...
                                    <input value="{{Auth::user()->role}}" type="hidden" name="role" class=" form-control" id="">
