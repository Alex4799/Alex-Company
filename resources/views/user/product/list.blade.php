                ...
                <div class=" d-flex justify-content-between">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="{{route('user#productList')}}">All</a></li>
                          @foreach ($category as $item)
                          <li><a class="dropdown-item" href="{{route('user#productList',['category_id'=> $item->id])}}">{{$item->name}}</a></li>
                          @endforeach
                        </ul>
                    </div>

                    <div class="table-data__tool-right">
                        <a href="{{route('user#productCreatePage')}}">
                                ...
                                <tr class="tr-shadow">
                                    ...
                                    <td class="col">
                                        <div class="table-data-feature">
                                         ...
                                         <a href="{{route('user#viewProduct',$item->id)}}" class="me-3">
                                             <button class="btn btn-dark" data-toggle="tooltip" data-placement="top" title="View">
                                                 <i class="fa-solid fa-eye"></i>
                                             </button>
                                         </a>

                                         <a href="{{route('user#deleteProduct',$item->id)}}" class="me-3">
