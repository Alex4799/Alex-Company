...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <p class="fs-3"><a href="{{route('user#productList')}}">Product</a>/View Product</p>
            <div class="col-lg-12">
                    ...
                    @endif
                        ...
                        <div class="row">
                            <div class=" offset-1 my-3">
                                <a href="{{route('user#editProduct',$data->id)}}" class=" btn btn-dark"><i class="fa-solid fa-pen-to-square"></i>Edit Product</a>
                            </div>
                        </div>
                    </div>
                </div>
