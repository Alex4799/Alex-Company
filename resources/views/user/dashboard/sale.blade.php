            ...
            <div class="col-lg-10 offset-lg-1">
                ...
                <div class="row">
                    ...
                    <div class="dropdown col-lg-3 offset-lg-4">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="{{route('user#saleDashboard')}}">Daily</a></li>
                          <li><a class="dropdown-item" href="{{route('user#saleDashboard',['productOrderPlan'=> 'month'])}}">Monthly</a></li>
                          <li><a class="dropdown-item" href="{{route('user#saleDashboard',['productOrderPlan'=> 'year'])}}">Yearly</a></li>
                        </ul>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="dropdown col-lg-3 offset-lg-4">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="{{route('user#saleDashboard')}}">All</a></li>
                          @foreach ($productsOrderDate as $item)
                            <li><a class="dropdown-item" href="{{route('user#saleDashboard',['productTrendPlan'=> $item->date])}}">{{$item->date}}</a></li>
                          @endforeach
                        </ul>
                    </div>
                </div>
