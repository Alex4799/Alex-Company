...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="col-md-12">
                <p class="fs-3"><a href="{{route('user#categoryList')}}">Category</a>/Edit Category</p>
                <div class="col-lg-10 offset-lg-1">
                    <div class="card bg-secondary">
                        <div class="card-body">
                            ...
                            <hr>
                                <form action="{{route('user#updateCategory',$data->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf
                                    <div class="">
