                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('profile#changePassword')}}" method="post" novalidate="novalidate">
                            ...
                            <div class="form-group">
                                ...
                                <input id="cc-pament2" name="newPassword" type="password" class="passwordInput form-control @error('oldPassword') is-invalid @enderror" aria-required="true" aria-invalid="false" placeholder="Enter New password...">
                                @error('newPassword')
                                <small class="text-danger">{{$message}}</small>
                                @enderror
                            </div>
