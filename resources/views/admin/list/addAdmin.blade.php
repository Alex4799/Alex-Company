...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="col-md-12">
                <p class="fs-3"><a href="{{route('admin#adminList')}}">Admin List</a>/Add Admin</p>
                <div class="col-lg-10 offset-lg-1">
                    <div class="card bg-secondary">
                        <div class="card-body">
                            <div class="card-title">
                                <h1 class="text-center title-2">Add Admin</h1>
                            </div>
                            <hr>
                                <form action="{{route('admin#addAdmin')}}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="row">
                                            <div class=" offset-1 my-3">
                                                ...
                                                <button type="submit" class=" btn btn-dark"><i class="fa-solid fa-pen-to-square"></i>Add Account</button>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6 offset-lg-1">
                                        ...
                                        <div class=" my-3">
                                            ...
                                            <input value="" type="trxt" name="NRC" class=" form-control @error('NRC') is-invalid @enderror" id="">
                                            @error('NRC')
                                            <small class=" text-danger">{{$message}}</small>
                                            @enderror
                                        </div>
