...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <p class="fs-3"><a href="{{route('admin#adminList')}}">Admin List</a>/Edit Profile</p>
            <div class="col-lg-10 offset-lg-1">
                <div class="card bg-secondary">
                    <div class="card-body">
                        ...
                        <hr>
                            <form action="{{route('admin#updateAdmin',$data->id)}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                ...
                                <div class="col-lg-6 offset-lg-1">
                                    ...
                                    <div class=" my-3">
                                        ...
                                        <input value="{{$data->position}}" type="text" name="position" class=" form-control" id="" >
                                    </div>
