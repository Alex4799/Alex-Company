...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <p class="fs-3"><a href="{{route('admin#customerList')}}">Customer List</a>/View Profile</p>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 offset-lg-1">
                                ...
                                <div class=" my-3"><h3><a class="text-dark text-decoration-none" href="{{route('admin#orderHistory',['search_key'=> $data->name])}}"><i class="fa-solid fa-chart-bar px-3"></i>{{$orderCount}}</a></h3></div>
                            </div>
                        </div>
                    </div>
                </div>
