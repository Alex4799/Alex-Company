                ...
                <div class=" d-flex justify-content-between">
                    ...
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                          <li><a class="dropdown-item" href="{{route('admin#messageList')}}">Inbox</a></li>
                          <li><a class="dropdown-item" href="{{route('admin#messageList',['sent_message'=>Auth::user()->email])}}" @if (request('sent_message')) selected @endif>Sent</a></li>
                        </ul>
                </div>

                    <div class="table-data__tool-right">
                        <a href="{{route('admin#messageSendPage')}}">
                    ...
                    <div class="col table-responsive mb-5">
                        <table class="table table-borderless table-hover text-center mb-0">
                            <tbody class="align-middle" id="tableData">
                                ...
                                <tr class="tr-shadow @if ($item->status==0) bg-white @else bg-secondary @endif">
                                    ...
                                    <td>
                                        ...
                                        <a href="{{route('admin#viewMessage',[$item->id,$item->user_id])}}" class="me-3">
                                        ...
                                        <a href="{{route('admin#deleteMessage',$item->id)}}" class="me-3">
