...
<div class="main-content">
    <div class="section__content section__content--p30">
        <div class="container-fluid">
            <div class="col-md-12">
                <!-- DATA TABLE -->
                <p class="fs-3"><a href="{{route('admin#messageList')}}">Message</a>/View Message</p>
                        ...
                        <div class=" card-body">
                            ...
                            <div class="row">
                                @if ($data->user_email==Auth::user()->email)
                                    <div class="col-3">
                                        <a href="{{route('admin#messageSendPage',['reply_message'=>$data->email])}}" class="btn btn-dark">Reply</a>
                                    </div>
                                @endif
                                @if ($data->status==0)
